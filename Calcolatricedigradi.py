...
if servizio_richiesto==celsius_kelvin:
    ...
    a=input("Inserisci il numero da convertire in Kelvin!")
    b=input("Inserisci 273.15! (per convertire il tuo numero in Kelvin)")
    c=float(x)+float(s)
    print("Il numero che vuoi convertire in Kelvin risulta",a)
elif servizio_richiesto==kelvin_celsius:
    print("Perfetto, hai scelto il servizio "+servizio_richiesto+" ! ")
    a=input("Inserisci il numero da convertire in Celsius!")
    b=input("Inserisci 273.15 (per convertire il tuo numero in Celsius)")
    c=float(x)-float(s)
